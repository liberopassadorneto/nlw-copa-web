...
export default function Home({ poolCount, guessCount, userCount }: HomeProps) {
  ...
  return (
    <div className="max-w-6xl h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        <Image src={logoSvg} alt="NLW Copa" quality={100} />
        <h1 className="mt-14 text-white text-5xl font-bold leading-tight">
          Crie seu próprio bolão da copa e compartilhe entre amigos!
        </h1>

        <div className="mt-10 flex items-center gap-2">
          <Image src={avatarsImg} alt="Avatares de pessoas" quality={100} />
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          ...
          />
          <button
            className="bg-yellow-500 px-6 py-4 rounded text-gray-900 font-bold text-sm uppercase hover:bg-yellow-600 transition-colors"
            type="submit"
          >
            Criar seu bolão
          </button>
        ...
        <div className="mt-10 pt-10 border-t border-gray-600 text-gray-100 flex justify-between">
          <div className="flex items-center gap-6">
            <Image src={checkIcon} alt="Check Icon" quality={100} />
      ...
      <Image
        src={mobilesImg}
        alt="Dois celulares exibindo uma prévia do app móvel"
        quality={100}
      />
    </div>
  );
